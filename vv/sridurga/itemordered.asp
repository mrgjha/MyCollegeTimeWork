...
<form name="Cancelitem" method=post action="delrID.asp?x=<%Response.write(Str)%>"
...
<form name="Cancelitem" method=post action="delitem.asp?x=<%Response.write(Str)%>"

<dl>


<img src="Balls10.gif"><b>Cancel Item<b> <input type="text" name="txtr" value="" size=10 maxlength=10>
...
<%	
	...
	strsql="SELECT * FROM Itemorder where Rid='" & Str & "';"
